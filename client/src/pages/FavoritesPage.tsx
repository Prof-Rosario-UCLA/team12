...
import { Clock, Users, Heart, ExternalLink, Info, Search } from 'lucide-react';
...
const FavoritesPage = () => {
  ...
  if (favoriteRecipes.length === 0) {
    return (
      <div className="container mx-auto px-4 py-8 text-center min-h-[calc(100vh-150px)] flex flex-col justify-center items-center">
